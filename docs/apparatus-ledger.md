...
Shell term **16581**, library term **8964**, ratio **1.85x**. The `archive/core148/` driver and
predictions module are in neither term — `be6cca9`'s amendment, working as ruled on the very next
campaign. A near-collision to disarm while it is still legible: at `be6cca9`, one commit ago, the
shell term read **16468**, and the composition section below reports **16466** for 2026-09-01 under a
*different definition* — four lines apart and unrelated. Two of those three figures are now behind us
and the pair that could be confused no longer sits in the same paragraph, which is the disarming;
